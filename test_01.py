...
# Replace with your actual Brave path:
brave_binary = r"C:\Program Files\BraveSoftware\Brave-Browser\Application\brave.exe"

# Create a Browser instance that connects to your real Brave
browser = Browser(
    config=BrowserConfig(
        chrome_instance_path=brave_binary,
...
async def browser_agent(query: str) -> str:
    ...
    agent = BrowserAgent(llm=LLM, task=query, controller=controller, browser=browser)
